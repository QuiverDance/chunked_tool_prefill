...
PYTHONPATH=src /home/pjw7200/chunked_tool_prefill/.conda/miniswe-py311/bin/python -m minisweagent.run.replay \
  ...
  -o /home/pjw7200/chunked_tool_prefill/replay_runs/mistral_small32_replay_500_20260708T115708Z/baseline_gpu0 \
  --algorithm baseline \
  --limit 500 \
  -c swebench_replay_output_first \
  -c /home/pjw7200/chunked_tool_prefill/replay_runs/mistral_small32_replay_500_20260708T115708Z/mistral_gpu0.yaml
